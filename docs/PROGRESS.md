...
**Последнее обновление:** 2026-08-02 (создание; DoD-закрытие этапов 1 — #7, 2 — #9, 4 — #10, 5 — #11).

## Сводка

| Показатель | Значение |
|---|---|
| Этапы | 5/8 закрыто (3, 1, 2, 4, 5); остальные 3: все атомы закрыты, ждут DoD-закрытия |
