...
**Последнее обновление:** 2026-08-02 (создание; DoD-закрытие этапов 1 — #7, 2 — #9, 4 — #10, 5 — #11, 6 — #12, 7 — #13).

## Сводка

| Показатель | Значение |
|---|---|
| Этапы | 7/8 закрыто (3, 1, 2, 4, 5, 6, 7); остался 1: все атомы закрыты, ждёт DoD-закрытия |
