...
> **Исторический трекер подпроекта `yt`.** Подпроект перенесён в отдельный
> git-репозиторий [amolofeev/youtrack-cli](https://github.com/amolofeev/youtrack-cli)
> (#53, 2026-08-02); трекер продолжается там. Здесь — архив истории этапов #5–#52 монорепо.
...
**Последнее обновление:** 2026-08-02 (перенос yt в youtrack-cli, #53).

## Сводка

| Показатель | Значение |
|---|---|
| Этапы | 8/8 закрыто (3, 1, 2, 4, 5, 6, 7, 8) |
...
| 2 | [#9](https://github.com/amolofeev/prompt-and-pray/issues/9) CLI-каркас | 2.1–2.4 | ✅ закрыт 2026-08-02 |
| 3 | [#8](https://github.com/amolofeev/prompt-and-pray/issues/8) API-клиент | 3.1–3.4 | 🟡 открыт — атомы закрыты, ждёт DoD-закрытия |
| 4 | [#10](https://github.com/amolofeev/prompt-and-pray/issues/10) Issue-команды | 4.1–4.6 | ✅ закрыт 2026-08-02 |
| 5 | [#11](https://github.com/amolofeev/prompt-and-pray/issues/11) Комментарии, поиск, командный язык | 5.1–5.5 | ✅ закрыт 2026-08-02 |
| 6 | [#12](https://github.com/amolofeev/prompt-and-pray/issues/12) Проекты и теги | 6.1–6.2 | ✅ закрыт 2026-08-02 |
| 7 | [#13](https://github.com/amolofeev/prompt-and-pray/issues/13) Формат вывода | 7.1–7.3 | ✅ закрыт 2026-08-02 |
| 8 | [#14](https://github.com/amolofeev/prompt-and-pray/issues/14) Полировка | 8.1–8.5 | ✅ закрыт 2026-08-02 |
