...
**Последнее обновление:** 2026-08-02 (создание; DoD-закрытие этапов 1 — #7, 2 — #9, 4 — #10, 5 — #11, 6 — #12).

## Сводка

| Показатель | Значение |
|---|---|
| Этапы | 6/8 закрыто (3, 1, 2, 4, 5, 6); остальные 2: все атомы закрыты, ждут DoD-закрытия |
