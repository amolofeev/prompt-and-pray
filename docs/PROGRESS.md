...
**Последнее обновление:** 2026-08-02 (создание, все атомы закрыты).

## Сводка

| Показатель | Значение |
|---|---|
| Этапы | 8/8: реализация завершена; все атомы закрыты, этапы ждут DoD-закрытия |
...
|---|---|---|---|
| 1 | [#7](https://github.com/amolofeev/prompt-and-pray/issues/7) Аутентификация и конфигурация | 1.1–1.2 | 🟡 открыт — атомы закрыты, ждёт DoD-закрытия |
